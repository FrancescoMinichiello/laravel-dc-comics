...
@section('main-content')
    <form method="" class="container py-5 my-5 border border-secondary rounded">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nationality" placeholder="Insert nationality" name="nationality">
        </div>
        <div class="d-flex gap-4">
            ...
            <div class="form-check my-3">
                <input class="form-check-input" type="radio" name="driving_license" id="driving_license_no" value="no"
                    checked>
        ...
        <div class="d-flex justify-content-end">
            <button class="bg-success p-3 rounded-2 mt-5 fw-bold text-white" type="submit">SALVA NUOVO DIPENDENTE</button>
        </div>
    </form>
@endsection
